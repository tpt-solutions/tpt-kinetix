...
//! in `kinetix-av1`) accept their tuning parameters through the codec-agnostic
...
impl SpeedPreset {
    ...
    ///
    /// ```
    /// use kinetix_core::encode::SpeedPreset;
    ///
...
///
/// ```
/// use kinetix_core::encode::{EncodeConfig, RateControl, SpeedPreset};
///
