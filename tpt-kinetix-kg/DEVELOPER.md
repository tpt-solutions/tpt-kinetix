# tpt-kinetix-kg developer guide

## What this tool does

`tpt-kinetix-kg` ingests C source code for a codec, builds a typed knowledge graph
...
```sh
tpt-kinetix-kg ingest path/to/codec/h264dec.c
```
...
```sh
tpt-kinetix-kg graph path/to/codec/h264dec.c -o h264.kg.json
```
...
```sh
tpt-kinetix-kg analyze h264.kg.json
```
