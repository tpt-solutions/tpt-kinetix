...
fn generate(dir: &std::path::Path) -> Option<Vec<u8>> {
    let h264 = dir.join("cavlc_mandelbrot_4x4.h264");
...
#[test]
fn dump_cavlc_mandelbrot_4x4() {
    let dir = std::env::temp_dir().join("tpt_kinetix_h264_mandelbrot_cavlc_4x4");
