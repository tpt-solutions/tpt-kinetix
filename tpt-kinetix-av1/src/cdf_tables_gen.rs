...
/// cost a constant +-1 on every subpel-MC block). Sets: 0 = EIGHTTAP_REGULAR,
...
/// on every subpel-MC block). Sets: 0 = EIGHTTAP_REGULAR,
/// 1 = EIGHTTAP_SMOOTH, 2 = EIGHTTAP_SHARP, 3 = 4x4-REGULAR,
/// 4 = 4x4-SMOOTH, 5 = BILINEAR. Luma (1/8-pel MVs) addresses only
/// the odd rows (2m-1 for phase m); even rows serve chroma 1/16 phases.
pub static SUBPEL_FILTERS: [[[i32; 8]; 15]; 6] = [
    // Set 0: EIGHTTAP_REGULAR (w>4 and h>4 blocks)
    [
        [0, 1, -3, 63, 4, -1, 0, 0],
        [0, 1, -5, 61, 9, -2, 0, 0],
        [0, 1, -6, 58, 14, -4, 1, 0],
    ...
    // Set 3: 4x4-REGULAR (regular/sharp kinds when w==4; regular/any when h==4)
    [
        [0, 0, -2, 63, 4, -1, 0, 0],
        [0, 0, -4, 61, 9, -2, 0, 0],
        [0, 0, -5, 58, 14, -3, 0, 0],
    ...
    // Set 4: 4x4-SMOOTH (smooth kind, w==4)
    [
        [0, 0, 15, 31, 17, 1, 0, 0],
        [0, 0, 13, 31, 18, 2, 0, 0],
        [0, 0, 11, 31, 20, 2, 0, 0],
