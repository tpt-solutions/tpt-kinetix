...
mod tests {
    ...
    fn sha256_known_empty() {
        ...
        let expected = hex_bytes("e3b0c44298fc1c149afbf4c8996fb92427ae41e4649b934ca495991b7852b855");
    ...
    fn sha256_known_abc() {
        // SHA-256 of "abc".
        let expected = hex_bytes("ba7816bf8f01cfea414140de5dae2223b00361a396177a9cb410ff61f20015ad");
